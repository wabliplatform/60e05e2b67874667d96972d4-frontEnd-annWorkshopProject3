let apiTaskApi = new TempApi.TaskApi();import TempApi from '../src/index';document.getElementById('if28b').onclick = (event) => {
    ...
    event.preventDefault();
    {  location.href= '/createEmployee' ;}};document.getElementById('i66eh').onclick = (event) => {
    event.preventDefault();
    ...
    { 
     ...
     location.href= '/updateTask/' + transitionId;}};document.getElementById('iufax').onclick = (event) => {
    event.preventDefault();
    ...
    apiTaskApi.deletetask( taskId, (error, data, response) => { if (error) {console.error(error);} else { console.log('API called successfully.');{  location.href= '/homePage' ;}}});};document.getElementById('izi4y').onclick = (event) => {
    event.preventDefault();
    { 
      let transitionId = window.location.href.split('/').at(-1);
      let parentId = "";
